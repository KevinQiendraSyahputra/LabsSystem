...
<div class="max-w-3xl mx-auto space-y-4 sm:space-y-6" x-data="maintenanceEdit()">
    ...
    <div class="bg-white shadow-sm border border-slate-200/80 rounded-2xl sm:rounded-3xl overflow-hidden">
        <div class="px-5 py-2.5 sm:py-3 border-b border-slate-800 bg-slate-900 text-white">
            <h2 class="text-sm sm:text-base font-bold text-white uppercase tracking-wider">Form Edit Data Maintenance</h2>
            <p class="text-xs text-slate-300 mt-0.5">Perbarui rincian perbaikan, status, dan biaya perawatan</p>
        </div>
